...
public class DeleteProblemServlet extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			PreparedStatement preparedstatement = connection.prepareStatement("UPDATE problem SET defunct = 'Y' WHERE problem_id=?");
			...
			out.println("<ul>");
			out.println((new StringBuilder()).append("<li>You have deleted a problem, the id is <font color=\"#CC9900\">").append(i).append("</font></li>").toString());
			out.println("</ul>");
			out.println("<p>");
