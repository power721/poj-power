	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			if (!resultset.next())
			{
				...
				out.println("<form method=POST action=modifyuser>");
				...
				out.println("<td><input type=password name=rptPassword size=20></td></tr>");
				out.println("<tr><td>School:</td>");
				out.println((new StringBuilder()).append("<td><input type=text name=school size=30 value=\"").append(Tool.titleEncode(s3)).append("\"></td></tr>").toString());
				out.println("<tr><td>Email:</td>");
				out.println((new StringBuilder()).append("<td><input type=text name=email size=30 value=\"").append(Tool.titleEncode(s2)).append("\"></td>").toString());
				out.println("</tr><tr><td>QQ:</td>");
				out.println("<td><input type=text name=qq size=20 value=" + qq + "></td>");
