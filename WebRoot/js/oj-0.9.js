...
function LimitAttachData(form, file) {
	...
	if (allowSubmit)
		...
		alert("å¯¹ä¸èµ·ï¼Œåªèƒ½ä¸Šä¼ ä»¥ä¸‹æ ¼å¼çš„æ–‡ä»¶:  " + (extArray.join("  ")) + "\nè¯·é‡æ–°é€‰æ‹©ç¬¦åˆæ¡ä»¶çš„æ–‡ä»¶"
				+ "å†ä¸Šä¼ .");
}
...
function checkQQ() {
	...
	alert("è¯·è¾“å…¥æ­£ç¡®çš„QQå·ç !æˆ–è€…ä¸å¡«å†™ã€‚");
	return false;
}
...
function tick() {
	var today;
	today = new Date();
	Clock.innerHTML = today.toLocaleString().replace(/(å¹´|æœˆ)/g, "-").replace(
			/æ—¥/, "");
...
function myprint() {
	...
	document
			.writeln("</br>&nbsp;&nbsp;<a href=../gongju/link.html><b><u><font color=red>OJå¤§å…¨</font></u></b></a></br>&nbsp;&nbsp;<a href=../gongju><b><u><font color=red>èµ„æ–™ä¸‹è½½</font></u></b></a></br>&nbsp;&nbsp;<a href=ACShare><b><u><font color=red>ACå…±äº«è®¡åˆ’</font></u></b></a></br>&nbsp;&nbsp;<b>PowerOJæµ‹è¯•ï¼Œå¦‚æžœé‡åˆ°é—®é¢˜è¯·è”ç³»<a href='mailto:power721@163.com'>ç®¡ç†å‘˜</a>ã€‚</b></br>");
}
function announcement() {
	document.writeln("----ä¿¡æ¯å·¥ç¨‹å­¦é™¢ACMé›†è®­é˜Ÿ</br>");
}
...
function cfdel(id, r) {
	...
	if (confirm("Are you sure to " + s + " this message?"
			+ (r == 0 ? "\næ³¨æ„æ—§ç‰ˆOJä¸èƒ½éšè—ï¼" : "\nåˆ é™¤åŠŸèƒ½ä¸å®Œå–„ï¼Œå°½é‡å°‘ç”¨ï¼"))) {
...
function newcopyCode(txt) {
	...
	if (window.netscape) {
		...
		try {
			...
			alert("è¢«æµè§ˆå™¨æ‹’ç»ï¼\nè¯·ä½ åœ¨æµè§ˆå™¨åœ°å€æ ä¸­è¾“å…¥'about:config'å¹¶ä¸”å›žè½¦\nç„¶åŽå°†'signed.applets.codebase_principal.support'è®¾ç½®ä¸ºtrue\nå¦‚æžœä½ æƒ³ä½¿ç”¨è¿™ä¸ªå¤åˆ¶åŠŸèƒ½çš„è¯ï¼Œé‚£ä¹ˆæœ€å¥½è¿™ä¹ˆè®¾ç½®^_^|||");
		}
